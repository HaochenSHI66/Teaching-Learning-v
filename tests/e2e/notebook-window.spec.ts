...
extract_payload = {
    "schema_version": 3,
    "page_num": 1,
    "text": "Gradient Descent overview",
    "summary": "Gradient Descent overview",
    "title_candidates": ["Gradient Descent"],
    "text_blocks": [{"id": "text-1", "type": "text", "bbox": [0, 0, 1, 1], "order": 0, "text": "Gradient Descent overview"}],
    "bullet_blocks": [],
    "figures": [],
    "tables": [],
...
meta = {
    ...
    "sections": {
        "translation_md": "### 完整翻译与解释\\n\\n<mark>梯度下降（Gradient Descent）</mark> 用来说明参数如何沿着负梯度方向更新。",
        "primary_md": "### 知识点总结\\n\\n这页主要介绍更新方向与学习率之间的关系。"
    }
}
...
connection.execute(
    ...
    (slide_id, document_id, 1, "slides/slide_001.png", "thumbnails/thumb_001.png", 300, 200),
)
connection.execute(
...
connection.execute(
    ...
    (explanation_id, document_id, slide_id, 1, markdown, json.dumps(meta), 4, now),
)
